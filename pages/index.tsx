...
const Home: NextPage<HomeProps> = ({ pokemon, initialPage, totalCount }) => {
    ...
    const loadMore = (): void => {
        ...
        fetch(`${process.env.NEXT_PUBLIC_VERCEL_URL}/api/pokemon/page/${nextPage}`)
...
export const getServerSideProps: GetServerSideProps = async () => {
    const currentPage = 1;
    const pokemon = await fetch(`${process.env.NEXT_PUBLIC_VERCEL_URL}/api/pokemon/page/${currentPage}`).then(
